...
3. 选择 `29x29`、`58x58`、`87x87`、自定义尺寸，或按原图比例只指定宽/高。
4. 可在 Photo 模式里调整亮度、对比度、饱和度，或打开 Floyd-Steinberg 抖动。
5. 简单纯色背景可以打开“自动抠图”，四角识别到的背景会变成空格，不计入材料。
6. 用“颜色筛选”只显示某个 MARD 色号；材料表里的色号也可以点击筛选。
7. 选择导出清晰度后下载网格 PNG、色号 PNG、图例 PNG、材料 CSV 或打印 PDF。
